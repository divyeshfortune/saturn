      ...
      <div className="container">
        ...
        <div className="grid md:grid-cols-12 sm:grid-cols-4 grid-cols-1 items-center gap-[1.875rem] mt-14">
            {frequently.map((items, index) => (
                <Link href="javascript:void(0)" key={index} className="bg-white flex items-center flex-col py-[1.8rem] rounded-[0.625rem] col-span-2 -mx-[0.30rem] gap-4 hover:shadow-[0_25px_60px_rgba(59,75,104,0.1)]" data-aos="fade-up" data-aos-delay={items.delay} data-aos-duration="1000">
