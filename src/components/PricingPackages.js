...
const PricingPackages = () => {
  ...
  return (
    <section className="relative border-t border-solid border-stroke dark:border-none dark:bg-darkmode">
      ...
      <div className="container">
        <div className="grid md:grid-cols-12 grid-cols-1 items-center md:-mx-4 mx-0 gap-[1.875rem] relative">
          ...
          <div className="col-span-4 mb-8 lg:mb-0 shadow-[0_0px_30px_rgba(24,23,23,0.1)] rounded-[0.3125rem] dark:bg-InkBlue">
