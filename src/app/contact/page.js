  ...
  return (
    <>
      ...
      <section className="dark:bg-darkmode">
        ...
        <div className="border-b border-solid border-stroke dark:border-darkborder"></div>
      </section>
      <section className="dark:bg-darkmode">
        <div className="container">
            <div className="grid md:grid-cols-12 grid-cols-1 gap-[1.875rem]">
                ...
                <div className="sm:w-[calc(50%_-_10px)] w-[calc(100%_-_0px)] mx-0 my-2.5">
                  ...
                  <input
                    className="w-full text-17 px-[0.9375rem] py-2.5 border-stroke border-solid dark:text-white dark:bg-darklight dark:border-darkborder border transition-all duration-500 focus:border-primary focus:border-solid focus:border"
                    type="text"
                  />
                </div>
                <div className="sm:w-[calc(50%_-_10px)] w-[calc(100%_-_0px)] mx-0 my-2.5">
                ...
                <label for="Specialist" className="pb-3 inline-block text-17 text-DeepOcean">Specialist*</label>
                  <select className="w-full text-17 px-[0.9375rem] py-2.5 text-DeepOcean border-stroke dark:text-white border-solid dark:bg-darklight dark:border-darkborder border transition-all duration-500 focus:border-primary focus:border-solid focus:border">
                ...
                <label for="date" className="pb-3 inline-block text-17 text-DeepOcean">Date*</label>
                  <input
                    className="w-full text-17 px-[0.9375rem] rounded-md text-DeepOcean py-2.5 outline-none dark:text-white dark:bg-darklight dark:border-darkborder border-stroke border-solid border transition-all duration-500 focus:border-primary focus:border-solid focus:border"
                    type="date"
                  />
                </div>
                <div className="sm:w-[calc(50%_-_10px)] w-[calc(100%_-_0px)] mx-0 my-2.5">
                <label for="time" className="pb-3 inline-block text-17 text-DeepOcean">Time*</label>
                  <input
                    className="w-full text-17 px-[0.9375rem] text-DeepOcean rounded-md py-2.5 border-stroke outline-none dark:text-white dark:bg-darklight dark:border-darkborder border-solid border transition-all duration-500 focus:border-primary focus:border-solid focus:border"
                    type="time"
                  />
                </div>
                <div className="mx-0 my-2.5 w-full">
                  <Link href="#" className="btn py-[1.1875rem] px-[3rem] mt-8 inline-block hover:shadow-[inset_-10.5rem_0_0_0_#102D47,inset_10.5rem_0_0_0_#102D47] dark:hover:shadow-[inset_-10.5rem_0_0_0_#12429A,inset_10.5rem_0_0_0_#12429A]" type="submit">
                    Make an appointment
                  </Link>
                </div>
              </form>
